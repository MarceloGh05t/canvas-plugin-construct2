...
AddAction(26, 0, "Fill path image", "Path", "Fill path image {0}", "Fill path image.", "fillPattern");

AddStringParam("path_img", "Fill path image: \"name archive or link\" ", "");
AddStringParam("effect", "Effect: \"name archive or 'contrast(1.4) sepia(1)\" ", "");
AddAction(27, 0, "Fill path image with effect", "Path", "Fill path image {0}, Effect{1}",  "Fill path image with effect.", "fillPatternEffect");
