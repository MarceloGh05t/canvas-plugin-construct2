...
AddCondition(0,	cf_trigger, "OnAnyTIFFComplete", "Canvas", "On any tiff data complete", "Triggered when any data tiff url request completes successfully.", "OnAnyTIFFComplete");


AddNumberParam("x", "x position on canvas", "0");
AddNumberParam("y", "y position on canvas", "0");
AddCondition(1, cf_none, "is Point In Stroke of Last Path", "Path", "Check is Point x {0}, y {1} in Stroke of Last Path", "Check is Point x and y in Stroke of Last Path", "isPointInStrokeLastPath");

AddCondition(2,	cf_trigger, "On Canvas To Svg Data Complete", "Canvas", "On canvas to svg data complete", "Triggered when request canvas to svg data completes successfully.", "OnCanvasToSvgDataComplete");
...
AddAction(24, 0, "Request TIFF Data URL", "Canvas", "Request tiff data url.", "Request tiff data url.", "RequestTIFFDataURL");

AddStringParam("pathSVG", "Draw SVG path example: \"M150 50 L75 200 L225 200 Z\" ", "");
AddAction(25, 0, "Draw SVG path", "Path", "Draw SVG path {0}", "Draw SVG path.", "drawSVGpath");

AddStringParam("path_img", "Fill path image: \"name archive or link\" ", "");
AddAction(26, 0, "Fill path with Pattern image", "Path", "Fill path with Pattern image {0}", "Fill path with Pattern image.", "fillPattern");

AddStringParam("path_img", "Fill path image: \"name archive or link\" ", "");
AddStringParam("effect", "Effect: \"name archive or 'contrast(1.4) sepia(1)\" ", "");
AddAction(27, 0, "Fill with Pattern path image with effect", "Path", "Fill path with Pattern image {0}, Effect{1}",  "Fill path with Pattern image with effect.", "fillPatternEffect");

AddNumberParam("x", "x position on canvas", "0");
AddNumberParam("y", "y position on canvas", "0");
AddAction(28, 0, "Move Path with translate", "Path", "Move Path with translate for ({0},{1}), but change identity matrix value", "Move Path with translate.", "MovePathWithTranslate");

AddAction(29, 0, "Reset Identity Matrix", "Path", "Reset Identity Matrix after changes the values of Identity Matrix", "Reset Identity Matrix.", "ResetIdentityMatrix");

AddStringParam("path_img", "image path: \"name archive or link\" ", "");
AddNumberParam("x", "x position on canvas", "0");
AddNumberParam("y", "y position on canvas", "0");
AddAction(30, 0, "Draw image Natural Size", "Canvas", "Draw image {0} in position ({1}, {2})",  "Draw image Natural Size.", "DrawImageNaturalSize");
...
AddNumberParam("width", "box width", "0");
AddNumberParam("height", "box height", "0");
AddAction(31, 0, "Draw image Scale Size", "Canvas", "Draw image {0} in position ({1}, {2}) with size: ({3},{4})",  "Draw image Scale Size.", "DrawImageScaleSize");

AddAction(32, 0, "Clip Path", "Path", "Clip current path", "Clip current path.", "ClipPath");

AddStringParam("options", "options to trace \"default\", \"posterized1\", \"posterized2\", \"curvy\", \"sharp\", \"detailed\", \"smoothed\", \"grayscale\", \"fixedpalette\", \"randomsampling1\", \"randomsampling2\", or more 1 options: \"ltres:0.1, qtres:1, scale:10\"", "");
AddAction(33, 0, "Request Canvas to SVG Data", "canvas", "Request image canvas to SVG data using {0} options", "Request Canvas to SVG Data.", "RequestCanvasToSVGData");

AddNumberParam("x", "Origin point x of path", "0");
AddNumberParam("y", "Origin point y of path", "0");
AddAction(34, 0, "Set Origin Point Path", "Path", "Set Origin Point Path to ({0},{1})", "Set Origin Point Path x and y.", "SetOriginPointPath");

AddNumberParam("x", "Origin point x of path", "0")
AddAction(35, 0, "Set Origin Point Path Only X", "Path", "Set Origin Point Path x to {0}", "Set Origin Point Path only x.", "SetOriginPointPathOnlyX");

AddNumberParam("y", "Origin point y of path", "0");
AddAction(36, 0, "Set Origin Point Path Only Y", "Path", "Set Origin Point Path y to {0}", "Set Origin Point Path only y.", "SetOriginPointPathOnlyY");
...
AddExpression(8, ef_return_string, "get tiff image from canvas", "canvas", "LastTIFFDataURL", "This returns a data tiff of the image on the canvas.");

AddExpression(9, ef_return_string, "get svg data image from canvas", "canvas", "CanvasSvgString", "This returns a svg data requested of the image on the canvas.");

AddExpression(10, ef_return_number, "get x origin point path", "Path Canvas", "OriginPointPathX", "This return x of origin point of path")

AddExpression(11, ef_return_number, "get y origin point path", "Path Canvas", "OriginPointPathY", "This return y of origin point of path")
